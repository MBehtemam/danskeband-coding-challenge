...
export interface BrandColors {
  ...
  /** Primary button background (#0A5EF0) */
  readonly primaryButton: string;
  /** Primary button hover state (#0852D1) */
...
export interface TypographyConfig {
  ...
  readonly h5: HeadingConfig;
  readonly h6: HeadingConfig;
  readonly body1: HeadingConfig;
  readonly body2: HeadingConfig;
  readonly caption: HeadingConfig;
}
...
export interface ShapeConfig {
  /** Small radius for inputs, chips (4px) */
  readonly borderRadiusSmall: 4;
  /** Medium radius for cards (8px) */
  readonly borderRadiusMedium: 8;
  /** Button radius for pill-shaped buttons (48px) */
  readonly borderRadiusButton: 48;
}
...
export interface ButtonConfig {
  /** Border radius for pill shape (48px) */
...
export interface DanskeBankTheme {
  ...
  readonly tableTypography: TableTypography;
}
